"""Главный модуль олдскульной RPG."""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция, определяющая наносимый урон при атаке."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция, определяющая блок при защите."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция, определяющая применение специального умения."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Управляющая функция. Запускает тренировку."""
    if char_class == 'warrior':
